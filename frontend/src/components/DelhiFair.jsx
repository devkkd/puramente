      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-stretch">
          ...
          <div className="w-full lg:col-span-5 relative min-h-[400px] lg:min-h-full rounded-xl overflow-hidden shadow-sm">
            ...
            <img
              src="/images/home/exhibhition-mobile.jpeg"
              alt="Puramente International Exhibition Booth"
              className="block lg:hidden absolute inset-0 w-full h-full object-contain"
            />
          </div>
          ...
          <div className="w-full lg:col-span-7 flex flex-col justify-center">
            ...
            <div className="w-full space-y-6">
              ...
              <div className="rounded-xl overflow-hidden shadow-sm border border-gray-100">
                <img
                  src="/images/home/delhi-fairs.png"
              ...
              <div className="grid grid-cols-1 xl:grid-cols-5 gap-6">
                ...
                <div className="xl:col-span-3 space-y-5">
                  <div className="bg-white rounded-xl shadow-md p-5 border-l-4 border-[#00a3c4]">
                    <h2 className="text-xl font-bold text-[#00a3c4] mb-2">
                      Welcome to IHGF Delhi Fair Autumn 2026
                    </h2>
                    <div className="bg-gradient-to-r from-[#6dd7e8] to-[#a6e1ff] h-1 w-24 mb-4 rounded-full" />
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                      <div className="bg-blue-50/50 p-4 rounded-xl border border-[#00a3c4]/20">
                        <h4 className="font-bold text-sm text-[#00a3c4] mb-2 flex items-center">
                          <span className="text-[#ff9f39] mr-2">&#10022;</span> Exclusive Collection
                        </h4>
                        <p className="text-gray-700 text-xs leading-relaxed">
                          Discover our custom jewellery collection, crafted with precision and designed to match international trends.
                        </p>
                      </div>
                      <div className="bg-[#ff9f39] p-4 rounded-xl flex items-center justify-center">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      {[
                        { color: '#00a3c4', title: 'Venue', line1: 'India Expo Centre', line2: 'Greater Noida' },
                ...
                <div className="xl:col-span-2 flex flex-col gap-5">
                  <div className="bg-[#00a3c4] rounded-xl shadow-lg p-5 text-white h-full flex flex-col justify-center">
                    <div className="text-center mb-5">
                      <span className="bg-[#ff9f39] text-white text-[10px] font-bold uppercase tracking-wider px-3 py-1 rounded-full">Autumn 2026</span>
                        ...
                        <React.Fragment key={label}>
                          <div className="flex flex-col items-center">
                            <div className="bg-white rounded-lg w-10 h-10 flex items-center justify-center shadow border-b-2 border-[#c28680]">
                              <span className="text-lg font-bold text-[#00a3c4]">{fmt(value)}</span>
                            </div>
                  ...
                  <div className="bg-white rounded-xl shadow-md p-5 border border-gray-100">
                    ...
                    <p className="text-xs sm:text-sm font-bold text-[#00a3c4] mb-2 mt-1">Export Promotion Council for Handicrafts</p>
